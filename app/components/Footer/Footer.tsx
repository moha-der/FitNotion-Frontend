export default function Footer() {
    return (
    <footer className="bg-webColor dark:bg-footerColor w-full py-8  bottom-0">
            <div className="max-w-screen-xl px-4 mx-auto">
                ...
                <div className="pt-8 flex max-w-xs mx-auto items-center justify-between">
                    <a href="#" className="text-white transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                ...
                <div className="text-center text-white dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
                    © 2024 FitNotion.  All rights reserved.
                </div>
            </div>
    </footer>
    );
