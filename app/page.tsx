      ...
      <div className='grid grid-cols-10 gap-2 mx-auto'>
          <div className='col-span-10 md:col-span-5 min-w-full'>
            <div className='flex flex-col items-center py-4 px-5'>
              ...
              <p className='text-base mt-2 text-center'>¿Estás listo para transformar tu relación con la comida? FitNotion es tu aliado.</p>
          ...
          <div className='col-span-10 md:col-span-5 p-4'>
            <Image src={Banner} alt={'Texto'} width={476} height={328} />
          </div>
      </div>
    </main>
  );
