      ...
      <div className='grid grid-cols-10 gap-4 md:max-w-6xl mx-auto '>
          <div className='col-span-10 md:col-span-5 min-w-full md:flex md:flex-col md:justify-center'>
            <div className='flex flex-col items-center py-4 px-5'>
              ...
              <Link href={'/register'} className="flex h-10 flex-col justify-center items-center rounded-lg mt-4 px-4 text-base sm:text-lg md:text-lg font-medium text-white transition-colors aria-disabled:cursor-not-allowed aria-disabled:opacity-50 w-full bg-webColor uppercase" > 
                Empieza Gratis
              </Link> 
            </div>
          </div>
          <div className='col-span-10 mx-auto md:col-span-5 p-4 md:flex md:flex-col md:justify-center'>
            <Image className='rounded-lg md:flex md:flex-col md:items-center' src={Banner} alt={'Texto'} width={476} height={328} priority />
          </div>
      </div>
    </section>
